...
def cosine(path_to_file):
    ...
    for window in w:
        for size in d:
            ...
            cos_sim = loaded_wv.wv.most_similar(positive=["homer"])
...
def euc(path_to_file):
    ...
    fileName = "W2V_euclidean_similarty_homer.csv"
    savedResult = path_to_file + fileName
...
def manh(path_to_file):
    ...
    fileName = "W2V_manhattan_similarty_homer.csv"
    savedResult = path_to_file + fileName
